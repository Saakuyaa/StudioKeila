...
<head>
    ...
    display: inline-block; /* Para que o botão se comporte como um bloco */
    font-size: 16px; /* Tamanho da fonte */
    margin: 10px 0; /* Margem do botão */
...
<body>
    ...
    <button onclick="window.location.href='inicial.html';">Voltar para a Página Inicial</button>
</body>
</html>
